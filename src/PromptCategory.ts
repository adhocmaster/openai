...
(async function() {
    ...
    // console.log(txtData)
    const txtData = `Mielle Organics Rosemary Mint Scalp & Hair Strengthening Oil With Biotin & Essential Oils, Nourishing Treatment for Split Ends and Dry Scalp for All Hair Types, 2-Fluid Ounces
    Bonnlo 3 Burner Outdoor Portable Propane Stove Gas Cooker, Heavy Duty Iron Cast Patio Burner with Detachable Stand Legs for Camp Cooking (3-Burner 225,000-BTU)
    ...
    const prompt = `You are an expert in understanding product categories and keywords. I need to extract categories and keywords of some products:
    \n\nJSON format: \n
        {
            name: string,
            category: string,
        ...
        Classification denotes the category of the product and keywords describe the products using a few keywords. For categories choose from ['Hair Care', 'Outdoor Cooking', 'Home Improvement', 'Electronics'] only. A product has one category and multiple keywords. Here is a list of products seperated by new lines. 
